...
<div id="content">
  <form id="form_hasil" action="<?php echo base_url(). 'index.php/konsultasi/simpan_data_konsultasi'; ?>" method="post" class="form-check">
    ...
    <div id="accordion" role="tablist">
      ...
      <div class="card">
      	<?php 
            $sql = mysqli_query($koneksi,"SELECT * FROM `kepribadian` WHERE `kepribadian`.`temperamen`='Sanguinis' AND `kepribadian`.`level`='emosi'");
      ...
      <div class="card">
      	<?php 
            $sql = mysqli_query($koneksi,"SELECT * FROM `kepribadian` WHERE `kepribadian`.`temperamen`='Sanguinis' AND `kepribadian`.`level`='pekerjaan'");
            $d = mysqli_fetch_array($sql);
        ?>
        <div class="card-header" id="heading1">
          <h5 class="mb-0">
      ...
      <div class="card">
      	<?php 
            $sql = mysqli_query($koneksi,"SELECT * FROM `kepribadian` WHERE `kepribadian`.`temperamen`='Sanguinis' AND `kepribadian`.`level`='orang tua'");
            $d = mysqli_fetch_array($sql);
        ?>
        <div class="card-header" id="heading1">
          <h5 class="mb-0">
      ...
      <div class="card">
      	<?php 
            $sql = mysqli_query($koneksi,"SELECT * FROM `kepribadian` WHERE `kepribadian`.`temperamen`='Sanguinis' AND `kepribadian`.`level`='teman'");
            $d = mysqli_fetch_array($sql);
        ?>
        <div class="card-header" id="heading1">
          <h5 class="mb-0">
